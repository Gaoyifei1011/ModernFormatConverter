...
namespace ModernFormatConverter.Views.Pages
{
    ...
    /// 音频转换页面
    /// </summary>
    public sealed partial class AudioConversionPage : Page
    {
        private readonly string OutputConfigurationString = ResourceService.AudioConversionResource.GetString("OutputConfiguration");
        ...
        // TODO：未完成
        public List<Type> PageList { get; } = [typeof(AudioListPage), typeof(VideoEditPage), typeof(AudioConversionOutputConfigurationPage), typeof(VideoExportPictureOutputConfigurationPage)];
        ...
        protected override void OnNavigatedTo(NavigationEventArgs args)
        {
            ...
            AudioConversionFrame.ContentTransitions = SuppressNavigationTransitionCollection;
