...
namespace ModernFormatConverter.Services.Settings
{
    ...
    public static class LanguageService
    {
        ...
        private static void InitializeLanguageList()
        {
            ...
            {
                LogService.WriteLog(TraceEventType.Error, nameof(ModernFormatConverter), nameof(LanguageService), nameof(InitializeLanguageList), 1, e);
        ...
        public static void SetLanguage(KeyValuePair<string, string> language)
        {
            ...
            {
                LogService.WriteLog(TraceEventType.Error, nameof(ModernFormatConverter), nameof(LanguageService), nameof(SetLanguage), 1, e);
            }
        }
    }
}
