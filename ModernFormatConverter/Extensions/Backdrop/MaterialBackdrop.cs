...
namespace ModernFormatConverter.Extensions.Backdrop
{
    /// <summary>
    /// 自定义扩展的背景色
    /// </summary>
    public sealed partial class MaterialBackdrop : SystemBackdrop
    {
        ...
        protected override void OnTargetConnected(ICompositionSupportsSystemBackdrop connectedTarget, XamlRoot xamlRoot)
        {
            ...
            {
                LogService.WriteLog(TraceEventType.Warning, nameof(ModernFormatConverter), nameof(MaterialBackdrop), nameof(OnTargetConnected), 1, new Exception());
