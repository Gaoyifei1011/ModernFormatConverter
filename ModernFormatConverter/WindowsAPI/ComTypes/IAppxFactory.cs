...
namespace ModernFormatConverter.WindowsAPI.ComTypes
{
    ...
    public interface IAppxFactory
    {
        ...
        [PreserveSig]
        int CreatePackageWriter([MarshalAs(UnmanagedType.Interface)] IStream outputStream, nint settings, out nint packageWriter);
        ...
        /// <returns>如果方法成功，则返回 S_OK。 否则，它将返回一个错误代码。</returns>
        [PreserveSig]
        int CreatePackageReader([MarshalAs(UnmanagedType.Interface)] IStream inputStream, out nint packageReader);
        ...
        /// <returns>如果方法成功，则返回 S_OK。 否则，它将返回一个错误代码。</returns>
        [PreserveSig]
        int CreateBlockMapReader([MarshalAs(UnmanagedType.Interface)] IStream inputStream, out nint blockMapReader);
        ...
        /// <returns>如果方法成功，则返回 S_OK。 否则，它将返回一个错误代码。</returns>
        [PreserveSig]
        int CreateValidatedBlockMapReader([MarshalAs(UnmanagedType.Interface)] IStream blockMapStream, [MarshalAs(UnmanagedType.LPWStr)] string signatureFileName, out nint blockMapReader);
    }
}
