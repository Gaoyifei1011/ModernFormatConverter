...
namespace ModernFormatConverter.WindowsAPI.PInvoke.Dxgi
{
    public static class DxgiLibrary
    {
        ...
        [DllImport(Dxgi, EntryPoint = "CreateDXGIFactory", CharSet = CharSet.Unicode, SetLastError = false, PreserveSig = true)]
        public static extern int CreateDXGIFactory(in Guid riid, [MarshalAs(UnmanagedType.Interface)] out IDXGIFactory ppFactory);
    }
}
